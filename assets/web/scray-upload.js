...
(function () {
  ...
  // Phone files only (native 15.10): a Hetzner row is in the catalogue with no
  // OneDrive copy too, but there is no file on the phone to upload - so no
  // upload offer, no blue badge and no Uncat entry for it.
