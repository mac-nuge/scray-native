...
(function () {
  ...
  function passesNoteFilter(entry) {
    ...
    // Keywords (picker 13.149 / stg-native 13.147) are tested on each
    // bookmark here; the base pass only kept videos with at least one match.
    if (typeof window.scrayNoteKeywordsPass === 'function' &&
        !window.scrayNoteKeywordsPass(entry.__bmNote || '')) return false;
    return true;
  }
